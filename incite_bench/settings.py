...
from typing import Literal, Sequence, Tuple, Union, TypeVar, Type
...
class AuroraSettings(BaseComputeSettings):
    ...
    walltime: str
    """Maximum job time."""
    cpus_per_node: int = 200
    """Up to 208 with multithreading."""
    cores_per_worker: float = 4
    """Number of cores per worker. Evenly distributed between GPUs."""
    ...
    def config_factory(self, run_dir: PathLike) -> Config:
        ...
        We will launch 12 workers per node, each pinned to a different GPU.
...
ComputeSettingsTypes = Union[
    LocalSettings, WorkstationSettings, LSFStJudeSettings, 
