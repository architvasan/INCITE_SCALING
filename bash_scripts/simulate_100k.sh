...
for n in "${node_list[@]}"; do
    ...
    mpirun -n $TOTAL_NUMBER_OF_RANKS -ppn 12 \
        ...
        python -m \
        incite_bench.simulate_explicit \
        -s ./input_data/system_nmnat2 \
        -n 6 \
        -N ${n} \
        -pd Simulation/simulate_100k/prod_nodes${n} \
        -tf Simulation/simulate_100k/simulation_times \
        > logs/simulate_100k${n}.log 2> logs/simulate_100k${n}.err
done
